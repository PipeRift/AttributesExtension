...
void FStringEnumCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> StructPropertyHandle,
...
void FStringEnumCustomization::CustomizeChildren(TSharedRef<class IPropertyHandle> StructPropertyHandle,
...
void FStringEnumCustomization::OnSelectionChanged(
	TSharedPtr<FString> SelectedItem, ESelectInfo::Type SelectInfo)
{
